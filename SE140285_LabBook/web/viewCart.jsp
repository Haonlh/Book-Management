                            ...
                            <c:if test="${map != null and !map.isEmpty()}">
                                ...
                                <c:if test="${not empty discount}">
                                    <c:if test="${not empty emptyDiscount}">
                                        <h4 style="color:grey;">${emptyDiscount}</h4>
                                    </c:if>
                                ...
                                <c:if test="${empty discount}">
                                    <c:if test="${not empty emptyDiscount}">
                                        <h4 style="color:blue;">${emptyDiscount}</h4>
                                    </c:if>
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#usediscount">
                                        USE DISCOUNT
                                    </button>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <form action="MainController">
                                                ...
                                                <td>
                                                    <a href="MainController?action=deleteProductFormCart&pk=${dto.key}" >
                                                        <img src="img/xoa.jpg" alt="khong_co_hinh" style="width:50px">
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="submit" name="action" value="checkUnitQuantityProduct" >
                                                         <img src="img/update2.jpg" alt="khong_co_hinh" style="width:50px">
                                                    </button>
