            ...
            <div class="row" id="body-row">
                ...
                <div class="col">
                    ...
                    <c:if test="${empty listOrder}">
                        <h1 style="text-align: center">History Cart 
                            Empty Please Buy Product</h1>
                    </c:if>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="dto" items="${listOrder}">
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"  data-toggle="modal" data-target="#exampleModalCenter${dto.orderID}">
                                               <img src="img/detail.jpg" alt="khong_co_hinh" style="width:50px">
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
